...
CMD_ID = f'{config.COMPANY_NAME}_{config.ADDIN_NAME}_createSizesScale'
CMD_NAME = 'KCG: Create Sizes with Scale'
CMD_Description = 'Create keycap sizes by scaling a connection between to halfs'
