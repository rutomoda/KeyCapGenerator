...
CMD_ID = f'{config.COMPANY_NAME}_{config.ADDIN_NAME}_cutSwitchDomes'
CMD_NAME = 'KCG: Cut Switch Domes'
CMD_Description = 'Cut the cutout on the bottom of the keycap for the switches'
...
COMMAND_BESIDE_ID = f'{config.COMPANY_NAME}_{config.ADDIN_NAME}_createSizes'
